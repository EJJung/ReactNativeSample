...
export function getISchools() {
    ...
    for (s of iSchoolNames) {
        if (s.includes("University of Michigan")) {
            //console.log("OOOOOOLLLLLLLYYYYY OOOOONNNNNEEE",s);
            iSchools.unshift(new iSchool(s));
        } else {
            //console.log(s);
...
//const objList = getISchools();

//console.log(Object.keys(objList[0]));
